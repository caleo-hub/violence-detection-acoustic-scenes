...
feature_extraction.process_all_films(output_file_path="src/h5_files_new/vsd_features.h5")

feature_extraction.create_labeled_features(
    features_h5_path="src/h5_files_new/vsd_features.h5",
    movie_annotations=movie_annotations,
    output_h5_path="src/h5_files_new/vsd_clipped_features.h5",
)
