...
feature_extraction = FilmFeatureExtractor(annotations= movie_annotations,
...
feature_extraction.create_labeled_features(features_h5_path='src/h5_files/vsd_features.h5',
