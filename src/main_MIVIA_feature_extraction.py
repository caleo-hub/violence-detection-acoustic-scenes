...
integrator.integrate_dataset(
    "Datasets/MIVIA_DB4_dist/training/sounds", "src/h5_files/MIVIA_train_dataset.h5"
)


feature_extractor = AudioFeatureExtractor(
    filename="src/h5_files/MIVIA_train_dataset.h5",
    file_output="src/h5_files/MIVIA_train_feature.h5",
)
...
integrator.integrate_dataset(
    "Datasets/MIVIA_DB4_dist/testing/sounds", "src/h5_files/MIVIA_test_dataset.h5"
)


feature_extractor = AudioFeatureExtractor(
    filename="src/h5_files/MIVIA_test_dataset.h5",
    file_output="src/h5_files/MIVIA_test_feature.h5",
)
