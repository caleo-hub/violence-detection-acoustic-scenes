...
def main():
    datasets_path = [
        (
            "HEAR_Train",
            "Datasets/HEAR Dataset/AUDIO/media/tiago/ESTUDO/DataSets/HEAR/__BASE_HEAR_V2/Audio/Train",
        ),
        (
            "HEAR_Test",
            "Datasets/HEAR Dataset/AUDIO/media/tiago/ESTUDO/DataSets/HEAR/__BASE_HEAR_V2/Audio/Test",
        ),
